/*
 * Pixel 7 Pro (cheetah), CP1A.260405.005.
 *
 * Kernel: 6.1.145-android14-11-gfa1d6308d1fe-ab14691759
 * GKI build: ab14691759, revision fa1d6308d1fe
 *
...
#define BUILD_VARIANT_LABEL "cheetah_CP1A260405005"
#define BUILD_FINGERPRINT \
  "google/cheetah/cheetah:16/CP1A.260405.005/15001963:user/release-keys"
...
#define ASHMEM_MISC_FOPS_OFF        0x0215c080ULL
#define ASHMEM_FOPS_OFF             0x0126fe88ULL
#define ASHMEM_IOCTL_OFF            0x00c222c8ULL
#define ASHMEM_COMPAT_IOCTL_OFF     0x00c22c00ULL
#define ASHMEM_MMAP_OFF             0x00c22c58ULL
#define ASHMEM_OPEN_OFF             0x00c22e78ULL
#define ASHMEM_RELEASE_OFF          0x00c22f00ULL
#define ASHMEM_SHOW_FDINFO_OFF      0x00c23020ULL

#define CONFIGFS_READ_ITER_OFF      0x004537e0ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x00453d10ULL
#define COPY_SPLICE_READ_OFF        0x003d57c0ULL
#define NOOP_LLSEEK_OFF             0x00387fc0ULL

#define INIT_TASK_OFF               0x01fff600ULL
#define ROOT_TASK_GROUP_OFF         0x021e7580ULL

#define SELINUX_BLOB_SIZES_OFF      0x015bc608ULL
#define SELINUX_ENFORCING_OFF       0x02239400ULL
#define SECURITY_HOOK_HEADS_OFF     0x015bbef8ULL

#define KMALLOC_CACHES_OFF          0x015bba38ULL
#define ANON_PIPE_BUF_OPS_OFF       0x010f91d0ULL

/* KASLR stage-zero references. */

#define SLIDE_NFULNL_LOGGER_OFF         0x01ff29c8ULL
#define SLIDE_LOGGERS_0_1_OFF           0x01ff2938ULL
#define SLIDE_RANDOM_BOOT_ID_DATA_OFF   0x021174c8ULL
#define SLIDE_INIT_TASK_OFF             INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF       ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF         0x0225a498ULL
