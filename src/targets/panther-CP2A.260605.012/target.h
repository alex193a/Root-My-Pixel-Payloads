/*
 * target.h — Pixel 7 (panther) / Android 17 QPR2
 *
 * Kernel: 6.1.157-android14-11-gbd23337e42e7-ab14791245
 * Build:  CP2A.260605.012
 *
 * Offsets extracted via vmlinux-to-elf from factory boot.img.
 * Struct offsets inherited from frankel-CP2A.260605.012 (same GKI kernel version).
 */

#ifndef OFFSET_H
#define OFFSET_H

#define BUILD_VARIANT_LABEL "panther_CP2A260605012"
#define BUILD_FINGERPRINT "google/panther/panther:17/CP2A.260605.012/15430684:user/release-keys"
...
#define ASHMEM_MISC_FOPS_OFF        0x0217cb70ULL   /* ashmem_miscs */
#define ASHMEM_FOPS_OFF             0x01280b50ULL
#define ASHMEM_IOCTL_OFF            0x00c38d28ULL
#define ASHMEM_COMPAT_IOCTL_OFF     0x00c38d28ULL   /* fallback: same as ioctl on this build */
...
#define SELINUX_ENFORCING_OFF       0x01fca8c0ULL   /* selinux_enforcing_boot */
...
/* ── Kernel-page layout (compatible with GKI 6.1) ──────────────────── */
/*     Same as frankel-CP2A.260605.012 — 4 KB pages, same rtmutex/waiter sizes. */
